...
from extractors.toulouse_entertainment_extractor import ToulouseEntertainmentExtractor
...
def main():
    ...
    if stats['total_venues'] > 0:
        ...
        try:
            ...
            logger.info(f"Successfully exported {stats['total_venues']:,} venues to {output_file}")
            ...
            for venue in sample_venues:
                ...
                logger.info(f"  • {venue.name} ({venue.location_type.value}) - {address}")
