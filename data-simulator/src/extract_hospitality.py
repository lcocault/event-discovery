...
from extractors.toulouse_hospitality_extractor import ToulouseHospitalityExtractor
...
def main():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler('../hospitality_extraction.log'),
    ...
    try:
        ...
        # Export to GeoJSON
        output_file = Path("../toulouse_hospitality_venues.geojson")
